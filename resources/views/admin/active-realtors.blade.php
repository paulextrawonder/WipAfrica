...
<html lang="en">
  <head>
    <title>Active Realtors | Administrative Dashboard</title>
          ...
          <section class="section">
            <div class="section-body">
              ...
              <div class="row mt-3 mb-5">
                <h2 class="dashboard__title mb-2">Active Realtors</h2>
                      ...
                      <tr>
                        ...
                        <td class="downline__border">
                          <button type="button"
                            ...
                            onclick="wipConfirm2('Continue With Blocking This User', 
                            'This User has been Blocked', 
                            'The User was not Blocked', `{{$data['realtor']['id']}}`)"
                          >
